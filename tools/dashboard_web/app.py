...
# Per-filename safety gate for the download endpoint. Filenames are
# generated by our own code (no user-supplied text enters the path),
# but the endpoint's public — a strict whitelist costs nothing and
# eliminates path-traversal as a class even if that invariant slips.
